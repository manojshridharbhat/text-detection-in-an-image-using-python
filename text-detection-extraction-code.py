# Text detection and Extraction in an using OpenCV,OCR

import cv2
import string
import pytesseract

pytesseract.pytesseract.tesseract_cmd = r"/Users/manojbhat/Documents/miniproject"

# Reading image 
img = cv2.imread("/Users/manojbhat/Documents/miniproject/Dream big.jpg")
